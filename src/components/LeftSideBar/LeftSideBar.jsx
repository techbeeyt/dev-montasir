...
const LeftSideBar = ({ refData }) => {
  ...
  useEffect(() => {
    ...
    // console.log("Inside viewport changed:", insideViewport);
    // console.log("scrollBreakPoints:", scrollBreakPoints);
    // console.log("insideVP:", insideVP);
  }, [insideVP, insideViewport, scrollBreakPoints]);
  return (
    <>
      <div
        onClick={() => {
        ...
        to="/"
      >
        <div className="w-14 lg:w-10 mt-4 lg:mt-0">
        ...
        <ul className="text-2xl flex flex-col text-slate-100 items-center font-Kanit gap-6 lg:gap-12">
            ...
            {insideViewport === "intro" ? (
              <>
                ...
                <motion.div
                  animate={{ x: 0 }}
                  initial={{ x: -100 }}
                  className="lg:hidden text-2xl font-semibold text-blue-700 bg-slate-200 p-2 rounded-md"
                >
                  <TiInfoLarge />
                </motion.div>
              </>
              ...
              <>
                <div className="hidden lg:block">Introduction</div>
                <div className="lg:hidden text-slate-200 p-2 rounded-md">
                  <TiInfoLarge />
                </div>
              </>
            )}
            ...
            {insideViewport === "skills" ? (
              <>
                ...
                <motion.div
                  animate={{ x: 0 }}
                  initial={{ x: -100 }}
                  className="lg:hidden text-2xl font-semibold bg-slate-100 text-blue-700 p-2 rounded-md"
                >
                  <GiSkills />
                </motion.div>
              </>
          ...
          >
            {insideViewport === "courses" ? (
              ...
              <>
                <div className="hidden lg:block">Statistics</div>
                <div className="lg:hidden text-slate-200 p-2 rounded-md">
                  <ImStatsBars />
                </div>
              </>
