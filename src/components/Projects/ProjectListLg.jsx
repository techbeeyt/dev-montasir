  ...
  return (
    <div className='rounded-lg lg:rounded-2xl overflow-hidden backdrop-blur-lg bg-blue-500 bg-opacity-20'>
        ...
        <div className='w-full flex justify-center items-center mt-4 flex-col p-4'>
            ...
            <p className='text-white font-Nunito-light hidden lg:block'>{description}</p>
            <Link to="/projects/id1" className='rounded-md text-slate-200 px-2 py-1 font-Nunito-light'>See Details</Link>
        </div>
