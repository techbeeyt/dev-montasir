...
const Projects = () => {
  return (
    ...
    <div className='lg:hidden flex justify-center items-center bg-blue-500 bg-opacity-20 backdrop-blur-md p-2 text-slate-100 text-xl font-semibold m-2 ml-0 rounded-md sticky top-0 z-20'>My Projects</div>
